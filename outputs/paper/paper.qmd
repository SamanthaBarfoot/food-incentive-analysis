...
In the @tbl-table1, the results are generally consistent across the 4 subgroups, in which there is low variance among the values in the various columns. This more-or-less even distribution of the races, genders and grades of students across tables of varying incentive levels speaks to the efficacy of the randomness that was intended in the original study. In the next section, we will dive into analyzing the correlation of several individual factors and the choices made in stage G2.
